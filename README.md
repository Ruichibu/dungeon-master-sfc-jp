...
## タイトルの表記に関して
ネット上やコミュニティでは中黒なしの「ダンジョンマスター」や略称の「ダンマス」と表記されることが多いですが

スーパーファミコン版のパッケージおよびマニュアルにおける公式の正式表記は**『ダンジョン・マスター』**（中黒あり）です。

当プロジェクトは「ダンジョン・マスター」「ダンジョンマスター」「ダンマス」全て使用します。
