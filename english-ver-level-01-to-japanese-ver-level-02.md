...
## ボタン (Buttons)
B01(06,17,S) 押すとボタンが消えて、その場にくぼみが出現する。くぼみの中にはファルシオンの剣が置いてある。
B02
B03
B04
...
## レバー (Levers)
V01(04,25,N) -> (05,23)のドアを開閉する
V02(06,21,S) -> (07,22)の落とし穴を閉じる
V03
V04
V05
...
## くぼみ (Alcove)
A01(06,18,N) -> (06,17,S) のボタンを押すと、ボタンが消えてくぼみが出現する。くぼみの中にはファルシオンの剣が置いてある。
